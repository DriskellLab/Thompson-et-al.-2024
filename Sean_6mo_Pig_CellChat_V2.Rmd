...
```{r}
##Subset
Mon6_cc <- subset(Mon6, idents = c('0 Pericyte', '1 Basal Krtno', '3 Fibroblast', '6 BV', '7 Krtno', '8 Div Krtno',
                     '11 CDH1 Krtno', '12 Basal Krtno', '16 Lymphatic'), invert = FALSE)#subset
Mon6_cc#view the subset

##Rename clusters to their #'s since this cleans up the CellChat plots
cluster_names <- c('Peri', '1', '3', '6', '7', '8', '11', '12', '16')
...
```{r}
save(cellchat, file = '/t2tb/Object/6mo_Pig_cellchat_v2.Rdata')
```
...
path_out <- '~/Desktop/Sean_CellChat/Plots/6mo_EpiDer/Cluster_CirclePlot/'
...
path_out <- '~/Desktop/Sean_CellChat/Plots/6mo_EpiDer/Path_CirclePlot/'
setwd(path_out)#need to change working directory to export plots b/c the plot is not a ggplot object
...
path_out <- '~/Desktop/Sean_CellChat/Plots/6mo_EpiDer/LR_Pair_CirclePlot/'
setwd(path_out)#need to change working directory to export plots b/c the plot is not a ggplot object
